...
O BePets é uma aplicação baseada em arquitetura MVC e princípios básico da programação utilizando Node.js para o desenvolvimento de sites.
...
$ git clone git@github.com:danielhessell/bepets.git
# ou clone usando https
$ git clone https://github.com/danielhessell/bepets.git
